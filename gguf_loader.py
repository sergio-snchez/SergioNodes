...
from .gguf_ops import GGMLTensor
from .gguf_dequant import is_quantized, dequantize_tensor

IMG_ARCH_LIST = {"flux", "sd1", "sdxl", "sd3", "aura", "hidream", "cosmos", "ltxv", "hyvid", "wan", "lumina2", "qwen_image", "qwen_image21"}
...
def gguf_sd_loader(path, handle_prefix="model.diffusion_model.", is_text_model=False):
    ...
    if arch_str in [None, "pig", "cow"]:
        ...
        from .gguf_convert import detect_arch
        try:
