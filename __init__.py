...
from .compare_videos_v2 import (
    NODE_CLASS_MAPPINGS as COMPARE_V2_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as COMPARE_V2_DISPLAY_MAPPINGS,
)
